...
import mem_voja2RF_pes_hop_twolayers
import importlib
#from nengo.spa.vocab import Vocabulary

importlib.reload(mem_voja2RF_pes_hop_twolayers)

class SPA_Mem_Voja2RF_Pes_Hop_TwoLayers(spa.module.Module):
    ...
    def __init__(self, n_neurons=1000, dimensions=None, input_vocab=None, output_vocab=None,
        ...
        with self:
            ...
            self.mem =  mem_voja2RF_pes_hop_twolayers.Mem_Voja2RF_Pes_Hop_TwoLayers(
                            n_neurons=n_neurons,
